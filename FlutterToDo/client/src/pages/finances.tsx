...
export default function Finances() {
  ...
  if (transactions.length > 0) {
    ...
    console.log('🧪 Date parsing test:', {
      ...
      parsedDate: new Date(firstTransaction.date || firstTransaction.createdAt),
      parsedDateISO: new Date(firstTransaction.date || firstTransaction.createdAt).toISOString(),
      currentDate: new Date().toISOString(),
      isValidDate: !isNaN(new Date(firstTransaction.date || firstTransaction.createdAt).getTime())
    });
  }
